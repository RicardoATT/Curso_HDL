...
-- Design Ports Information
-- Sum	=>  Location: PIN_N3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF Adder_Cin_VHDL IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Sum~0_combout\ = \B~input_o\ $ (\Cin~input_o\ $ (\A~input_o\))
