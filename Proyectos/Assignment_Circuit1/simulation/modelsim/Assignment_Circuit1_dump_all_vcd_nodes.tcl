...
# ***************************************************************************
# 
# File:		C:/Users/Ricardo Aldair TT/Documents/RATT_repos/Curso_HDL/Proyectos/Assignment_Circuit1/simulation/modelsim/Assignment_Circuit1_dump_all_vcd_nodes.tcl
# 
...
# 
# Usages:	C:/Users/Ricardo Aldair TT/Documents/RATT_repos/Curso_HDL/Proyectos/Assignment_Circuit1/simulation/modelsim/Assignment_Circuit1_dump_all_vcd_nodes.tcl
# 
# Generated by:	Quartus Prime
# 		Version 18.1.0 Build 625 09/12/2018 SJ Lite Edition
# 
# Date:		Wed May 15 23:58:02 2024
# 
# Design:	Assignment_Circuit1
# 
# ***************************************************************************
# ***************************************************************************
...
# ----------------------------------------------------------------
   ...
   catch { vcd add "$hierarchy/Stop_areg0_q" }
   catch { vcd add "$hierarchy/Stop_a0_combout" }
   catch { vcd add "$hierarchy/Right_aoutput_o" }
   catch { vcd add "$hierarchy/Select_aoutput_o" }
   catch { vcd add "$hierarchy/Stop_aoutput_o" }
   catch { vcd add "$hierarchy/Mask_ainput_o" }
...
# ----------------------------------------------------------------
   ...
   set vcd_filename "Assignment_Circuit1.vcd"
   set hierarchy "i1"
