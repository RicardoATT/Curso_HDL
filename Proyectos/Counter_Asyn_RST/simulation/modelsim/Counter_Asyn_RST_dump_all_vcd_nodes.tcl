...
# ***************************************************************************
# 
# File:		C:/Users/Usuario/Documents/RATT_repositorios/Curso_HDL/Proyectos/Counter_Asyn_RST/simulation/modelsim/Counter_Asyn_RST_dump_all_vcd_nodes.tcl
# 
...
# 
# Usages:	C:/Users/Usuario/Documents/RATT_repositorios/Curso_HDL/Proyectos/Counter_Asyn_RST/simulation/modelsim/Counter_Asyn_RST_dump_all_vcd_nodes.tcl
# 
# Generated by:	Quartus Prime
# 		Version 18.1.0 Build 625 09/12/2018 SJ Lite Edition
# 
# Date:		Thu Apr 11 18:15:34 2024
# 
# Design:	Counter_Asyn_RST
# 
# ***************************************************************************
# ***************************************************************************
...
# ----------------------------------------------------------------
   ...
   catch { vcd add "$hierarchy/Count_Out_a1_a_a7_combout" }
   catch { vcd add "$hierarchy/Count_Out_a1_a_a8" }
   catch { vcd add "$hierarchy/Count_Out_a2_a_a9_combout" }
   catch { vcd add "$hierarchy/Count_Out_a2_a_a10" }
   catch { vcd add "$hierarchy/Count_Out_a3_a_a11_combout" }
   catch { vcd add "$hierarchy/Count_Out_a3_a_a12" }
   catch { vcd add "$hierarchy/Count_Out_a4_a_a13_combout" }
   catch { vcd add "$hierarchy/Count_Out_a4_a_a14" }
   catch { vcd add "$hierarchy/Count_Out_a5_a_a15_combout" }
   catch { vcd add "$hierarchy/Count_Out_a5_a_a16" }
   catch { vcd add "$hierarchy/Count_Out_a6_a_a17_combout" }
   catch { vcd add "$hierarchy/Count_Out_a6_a_a18" }
   catch { vcd add "$hierarchy/Count_Out_a7_a_a19_combout" }
   catch { vcd add "$hierarchy/Count_Out_a0_a_areg0_q" }
   catch { vcd add "$hierarchy/Count_Out_a0_a_a21_combout" }
...
# ----------------------------------------------------------------
   ...
   set vcd_filename "Counter_Asyn_RST.vcd"
   set hierarchy "i1"
