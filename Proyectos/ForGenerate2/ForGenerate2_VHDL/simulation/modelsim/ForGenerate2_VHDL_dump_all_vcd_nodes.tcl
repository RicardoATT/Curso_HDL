...
# ***************************************************************************
# 
# File:		C:/Users/Usuario/Documents/RATT_repositorios/Curso_HDL/Proyectos/ForGenerate2/ForGenerate2_VHDL/simulation/modelsim/ForGenerate2_VHDL_dump_all_vcd_nodes.tcl
# 
...
# 
# Usages:	C:/Users/Usuario/Documents/RATT_repositorios/Curso_HDL/Proyectos/ForGenerate2/ForGenerate2_VHDL/simulation/modelsim/ForGenerate2_VHDL_dump_all_vcd_nodes.tcl
# 
# Generated by:	Quartus Prime
# 		Version 18.1.0 Build 625 09/12/2018 SJ Lite Edition
# 
# Date:		Thu May 16 17:25:55 2024
# 
# Design:	ForGenerate2_VHDL
# 
# ***************************************************************************
# ***************************************************************************
...
# ----------------------------------------------------------------
   ...
   catch { vcd add "$hierarchy/S0_a0_combout" }
   catch { vcd add "$hierarchy/S0_a1_combout" }
   catch { vcd add "$hierarchy/S0_a2_combout" }
   catch { vcd add "$hierarchy/S0_a3_combout" }
   catch { vcd add "$hierarchy/S0_a4_combout" }
   catch { vcd add "$hierarchy/S0_a5_combout" }
   catch { vcd add "$hierarchy/S0_a6_combout" }
   catch { vcd add "$hierarchy/S0_a7_combout" }
   catch { vcd add "$hierarchy/a_aG1_a0_aU0_aSc_acombout" }
   catch { vcd add "$hierarchy/a_aG1_a1_aU0_aSc_acombout" }
   catch { vcd add "$hierarchy/a_aG1_a2_aU0_aSc_acombout" }
   catch { vcd add "$hierarchy/a_aG1_a3_aU0_aSc_acombout" }
   catch { vcd add "$hierarchy/a_aG1_a4_aU0_aSc_acombout" }
   catch { vcd add "$hierarchy/a_aG1_a5_aU0_aSc_acombout" }
   catch { vcd add "$hierarchy/a_aG1_a6_aU0_aSc_acombout" }
   catch { vcd add "$hierarchy/a_aG1_a7_aU0_aSc_acombout" }
   catch { vcd add "$hierarchy/S0_a0_a_aoutput_o" }
   catch { vcd add "$hierarchy/S0_a1_a_aoutput_o" }
   catch { vcd add "$hierarchy/S0_a2_a_aoutput_o" }
   catch { vcd add "$hierarchy/S0_a3_a_aoutput_o" }
   catch { vcd add "$hierarchy/S0_a4_a_aoutput_o" }
   catch { vcd add "$hierarchy/S0_a5_a_aoutput_o" }
   catch { vcd add "$hierarchy/S0_a6_a_aoutput_o" }
   catch { vcd add "$hierarchy/S0_a7_a_aoutput_o" }
...
# ----------------------------------------------------------------
   ...
   set vcd_filename "ForGenerate2_VHDL.vcd"
   set hierarchy "i1"
