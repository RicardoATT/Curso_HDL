...
# ***************************************************************************
# 
# File:		C:/Users/Ricardo Aldair TT/Documents/RATT_repos/Curso_HDL/Proyectos/FSM_1ShiftRegister/simulation/modelsim/FSM_1ShiftRegister_dump_all_vcd_nodes.tcl
# 
...
# 
# Usages:	C:/Users/Ricardo Aldair TT/Documents/RATT_repos/Curso_HDL/Proyectos/FSM_1ShiftRegister/simulation/modelsim/FSM_1ShiftRegister_dump_all_vcd_nodes.tcl
# 
# Generated by:	Quartus Prime
# 		Version 18.1.0 Build 625 09/12/2018 SJ Lite Edition
# 
# Date:		Sun Jun 02 03:48:48 2024
# 
# Design:	FSM_1ShiftRegister
# 
# ***************************************************************************
# ***************************************************************************
...
# ----------------------------------------------------------------
   ...
   catch { vcd add "$hierarchy/ZerosOnes\[2\]" }
   catch { vcd add "$hierarchy/ZerosOnes\[1\]" }
   catch { vcd add "$hierarchy/ZerosOnes\[0\]" }
   catch { vcd add "$hierarchy/BeforeWasOne_aq" }
   catch { vcd add "$hierarchy/ZerosOnes\[3\]" }
   catch { vcd add "$hierarchy/Equal0_a0_combout" }
   catch { vcd add "$hierarchy/Equal0_a1_combout" }
   catch { vcd add "$hierarchy/ZerosOnes_a0_combout" }
   catch { vcd add "$hierarchy/ZerosOnes_a1_combout" }
   catch { vcd add "$hierarchy/ZerosOnes_a2_combout" }
   catch { vcd add "$hierarchy/ZerosOnes_a3_combout" }
...
# ----------------------------------------------------------------
   ...
   set vcd_filename "FSM_1ShiftRegister.vcd"
   set hierarchy "i1"
