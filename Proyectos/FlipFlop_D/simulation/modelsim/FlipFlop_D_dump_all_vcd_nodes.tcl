...
# ***************************************************************************
# 
# File:		C:/Users/Usuario/Documents/RATT_repositorios/Curso_HDL/Proyectos/FlipFlop_D/simulation/modelsim/FlipFlop_D_dump_all_vcd_nodes.tcl
# 
...
# 
# Usages:	C:/Users/Usuario/Documents/RATT_repositorios/Curso_HDL/Proyectos/FlipFlop_D/simulation/modelsim/FlipFlop_D_dump_all_vcd_nodes.tcl
# 
# Generated by:	Quartus Prime
# 		Version 18.1.0 Build 625 09/12/2018 SJ Lite Edition
# 
# Date:		Thu May 23 23:30:40 2024
# 
# Design:	FlipFlop_D
# 
# ***************************************************************************
...
# ----------------------------------------------------------------
   ...
   catch { vcd add "$hierarchy/U1_aNAND4_acombout" }
   catch { vcd add "$hierarchy/U1_aNAND2_acombout" }
   catch { vcd add "$hierarchy/U1_aNAND3_acombout" }
   catch { vcd add "$hierarchy/U1_aNAND1_acombout" }
   catch { vcd add "$hierarchy/U0_aNAND4_acombout" }
   catch { vcd add "$hierarchy/U0_aNAND2_acombout" }
   catch { vcd add "$hierarchy/U0_aNAND3_acombout" }
   catch { vcd add "$hierarchy/U0_aNAND1_acombout" }
   catch { vcd add "$hierarchy/L1_acombout" }
...
# ----------------------------------------------------------------
   ...
   set vcd_filename "FlipFlop_D.vcd"
   set hierarchy "i1"
